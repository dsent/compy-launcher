...
- **Startup storage**: Launcher waits up to 30 seconds for Android to mount the SD card before checking it and recovering interrupted restores. A card that remains unavailable shows the storage warning; Maintenance remains accessible.
